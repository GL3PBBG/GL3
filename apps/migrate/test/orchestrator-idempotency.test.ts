...
import { bounties, detectiveSearches, forumPosts, forumTopics, forums, garage, membershipPackages, propertiesPlugin } from "../src/pg/plugin-tables.js";
...
const ALL_TABLES = [
  ...
  forums, forumTopics, forumPosts, membershipPackages,
  settings, idMap,
] as const;
