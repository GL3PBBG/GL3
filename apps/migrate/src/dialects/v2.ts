...
/**
 * Moved verbatim from orchestrator.ts (B1 Task 5 — the extraction's
 * acceptance test is the migrate suite passing unmodified): same phase
 * order, same guards, same migrators.
 */
export const v2Dialect: SourceDialect = {
  id: "v2",
  label: "Gangster Legends V2",
  sourceKind: "mysql",
