...
const BLENDED_CRIME_ROWS = () => [
  { id: uuidv7(), name: "Pickpocket", description: "Lift a wallet in a crowd.", cooldownSeconds: 20, braveCost: 2, minPayout: 50n, maxPayout: 250n, minBullets: 0, maxBullets: 0, expReward: 5n, crimeExpReward: 2n, minRank: 0, sort: 10, jailChancePercent: 5, jailSeconds: 30, successFormula: "min(95, 20 + CRIMEXP / 50)" },
  { id: uuidv7(), name: "Shoplift", description: "Walk out wearing it.", cooldownSeconds: 30, braveCost: 3, minPayout: 100n, maxPayout: 400n, minBullets: 0, maxBullets: 0, expReward: 8n, crimeExpReward: 3n, minRank: 0, sort: 20, jailChancePercent: 10, jailSeconds: 45, successFormula: "min(90, 15 + CRIMEXP / 40)" },
  { id: uuidv7(), name: "Pick a Lock", description: "Quiet hands, quiet street.", cooldownSeconds: 45, braveCost: 4, minPayout: 200n, maxPayout: 700n, minBullets: 0, maxBullets: 0, expReward: 12n, crimeExpReward: 5n, minRank: 0, sort: 30, jailChancePercent: 15, jailSeconds: 60, successFormula: "min(90, 10 + CRIMEXP / 30 + IQ / 200)" },
  { id: uuidv7(), name: "Mug a Stranger", description: "Pick someone who looks flush.", cooldownSeconds: 60, braveCost: 6, minPayout: 300n, maxPayout: 1200n, minBullets: 0, maxBullets: 0, expReward: 18n, crimeExpReward: 7n, minRank: 0, sort: 40, jailChancePercent: 20, jailSeconds: 90, successFormula: "min(85, 10 + LEVEL * 3 + CRIMEXP / 60)" },
  { id: uuidv7(), name: "Rob a Store", description: "Hold up the corner shop.", cooldownSeconds: 90, braveCost: 8, minPayout: 600n, maxPayout: 2500n, minBullets: 0, maxBullets: 2, expReward: 25n, crimeExpReward: 10n, minRank: 0, sort: 50, jailChancePercent: 25, jailSeconds: 120, successFormula: "min(80, 5 + LEVEL * 3 + CRIMEXP / 80)" },
  { id: uuidv7(), name: "Boost a Car", description: "The keys are a suggestion.", cooldownSeconds: 150, braveCost: 10, minPayout: 1200n, maxPayout: 5000n, minBullets: 0, maxBullets: 0, expReward: 35n, crimeExpReward: 14n, minRank: 0, sort: 60, jailChancePercent: 30, jailSeconds: 180, successFormula: "min(75, 5 + LEVEL * 2 + CRIMEXP / 100 + WILL / 20)" },
  { id: uuidv7(), name: "Armoured Van", description: "Take the van on the freeway.", cooldownSeconds: 300, braveCost: 14, minPayout: 2500n, maxPayout: 9000n, minBullets: 1, maxBullets: 5, expReward: 50n, crimeExpReward: 20n, minRank: 0, sort: 70, jailChancePercent: 35, jailSeconds: 240, successFormula: "min(70, LEVEL * 2 + CRIMEXP / 150)" },
  { id: uuidv7(), name: "Museum Heist", description: "In through the skylight.", cooldownSeconds: 600, braveCost: 20, minPayout: 6000n, maxPayout: 25000n, minBullets: 0, maxBullets: 0, expReward: 90n, crimeExpReward: 35n, minRank: 0, sort: 80, jailChancePercent: 40, jailSeconds: 300, successFormula: "min(65, max(5, LEVEL * 2 + CRIMEXP / 200 + IQ / 100))" },
];
