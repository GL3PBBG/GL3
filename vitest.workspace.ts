  ...
  },
  {
    test: {
      ...
      include: [
        ...
        "test/world-venues-pure.test.ts",
  ...
  },
  {
    test: {
      ...
      include: [
        ...
        "test/casino-floor.test.ts",
        "test/casino-interior-acceptance.test.ts",
        "test/combat-action-cost.test.ts",
