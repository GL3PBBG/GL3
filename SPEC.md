# GL3 — Build Specification for Claude Code
...
**Audience of this document:** Claude Code, executing the build. Sections are ordered so that each milestone is independently verifiable.
