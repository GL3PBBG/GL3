...
const MESSAGES: Record<string, string> = {
  ...
  sole_administrator: "You're the only administrator — give another player the Administrator role first.",
  ...
  terms_not_accepted: "Accept the Terms of Service and Privacy Policy to register.",
  ...
  machine_open: "You already have credits on a machine. Reload to resume it.",
  stale_machine: "The machine changed in another request. Its current credits have been refreshed.",
  machine_closed: "This machine session has already been cashed out.",
  insufficient_credits: "There aren't enough machine credits for that bet.",
  machine_credit_limit: "Cash out before adding more winnings to this machine.",
  no_such_machine: "This machine is unavailable. You can still cash out your unused credits.",
  round_open: "Finish the current round before spinning again.",
  round_finished: "That round has already finished.",
